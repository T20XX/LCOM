...
typedef enum {BUTTON0_SELECT, BUTTON1_SELECT, BUTTON2_SELECT, BUTTON3_SELECT, BUTTON4_SELECT, BUTTON5_SELECT, SINGLEPLAYER, MULTIPLAYER, HIGHSCORES, CLOSE, DONOTHING} main_menu_state;
